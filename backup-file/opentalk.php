<div class="opentalk-news-title"> <div class="opentalk-news"><a href="#">মুক্তকথা</a> </div> 
<div class="clr"></div>
</div>
...
<a href="indetails.php?title=<?php echo $vquery2['title']; ?>"><img src="admin/<?php echo $vquery2['images']; ?>" class="edit-images"></a>
 ...
 <ul>
   ...
   <?php
	...
	$query= "SELECT * FROM newstype WHERE category='opentalk' order by nid DESC LIMIT 1, 5";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
   ?>
