<div class="news-title"><a href="inn.php?catid=specialfeature"><img src="images/special.png"></a><!-- বিশেষ প্রতিবেদন--> </div>

<div class="edit-news"> 
  <?php
	
	$query= "SELECT * FROM newstype WHERE category='specialfeature' order by nid DESC LIMIT 1";
...
<a href="indetails.php?title=<?php echo $vquery2['title']; ?>"><img src="admin/<?php echo $vquery2['images']; ?>" class="edit-images"></a>
 ...
 <ul>
   ...
   <?php
	...
	$query= "SELECT * FROM newstype WHERE category='specialfeature' order by nid DESC LIMIT 1, 5";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
   ?> 
