<div class="interview-news-title"> <div class="interview-news"><a href="inn.php?catid=interview">সাক্ষাৎকার</a> </div> 
<div class="clr"></div>
</div>
...
<?php
	...
	$query= "SELECT * FROM newstype WHERE category='interview' order by nid DESC LIMIT 1, 6";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
?>
