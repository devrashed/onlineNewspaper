...
$Vquery .= "author='".$_POST['reporter']."',slideshow='".$_POST['slide']."',bracking='".$_POST['bknews']."',youtube='".$_POST['youtube']."',important='".$_POST['important']."',ctime= '".$CUR_D_Bangladesh."',cdate='".$GM_D ."',btime='".$presenttime."', bdate='".$presentDate."' WHERE nid='".$_POST['Regisid']."'";
...
$Vquery= "UPDATE videogallery SET vtitle='".$_POST['vtitle']."',vurl='".$_POST['urllink']."',cdate='".$GM_D ."' WHERE vid='".$_POST['Regisid']."'";
...
$Vquery= "UPDATE admin SET first_name='".$_POST['firstname']."',last_name='".$_POST['lastname']."',email='".$_POST['email']."',
username='".$_POST['username']."',password='".$_POST['password']."',phone='".$_POST['phone']."',address='".$_POST['address']."',
status='".$_POST['status']."',type='".$_POST['utype']."' WHERE id='".$_POST['Regisid']."'";
...
$Query=mysql_query($Vquery); 
	...
	{
	 $msg="Update succesfully" ;
	 header("location:admin.php?action=newuser&catid=viewuser&msg=$msg"); //&msg=$msg
	 die ();
	 
	} else {  
	
   $errors="Update unsuccessfull" ; 
   header("location:admin.php?action=newuser&catid=edituser&errors=$errors&bid=".$_POST['Regisid']."");
   die ();
      }	
    }
?> 
...
$Vquery= "UPDATE menu SET menuname='".$_POST['menu']."' WHERE mid='".$_POST['Regisid']."'";
...
$Query=mysql_query($Vquery); 
	...
	{
	 $msg="Update succesfully" ;
	 header("location:admin.php?action=menu&catid=viewmenu&msg=$msg"); //&msg=$msg
	 die ();
	 
	} else {  
	
   $errors="Update unsuccessfull" ; 
   header("location:admin.php?action=menu&catid=editmenu&errors=$errors&mid=".$_POST['Regisid']."");
   die ();
      }	
    }
?> 
...
$Vquery= "UPDATE permission SET uid='".$_POST['uname']."',menuid='".$_POST['menuname']."',permite='".$_POST['permite']."' WHERE prid='".$_POST['Regisid']."'";
$Query=mysql_query($Vquery); 

	if($Query)
	{
	 $msg="Update succesfully" ;
	 header("location:admin.php?action=permission&catid=viewpermission&msg=$msg"); //&msg=$msg
	 die ();
	 
	} else {  
	
   $errors="Update unsuccessfull" ; 
   header("location:admin.php?action=permission&catid=editpermission&errors=$errors&mid=".$_POST['Regisid']."");
   die ();
      }	
    }
?> 
...
$Vquery= "UPDATE newstype SET title='".$_POST['Istitle']."',category='dorbarsharif',description='".$content."',";
...
$Query=mysql_query($Vquery); 
	...
	{
	 $msg="Update succesfully" ;
	 header("location:admin.php?action=islam&catid=viewdor&msg=$msg"); //&msg=$msg
	 die ();
	}
	else
	{  
   $errors="Update unsuccessfull" ; 
   header("location:admin.php?action=islam&catid=editndor&errors=$errors&nid=".$_POST['Regnid']."");
   die ();
      }	
    }
?>  
...
$Vquery= "UPDATE newstype SET title='".$_POST['Istitle']."',category='khatme',description='".$content."',";
