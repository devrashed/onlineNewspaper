...
if($_POST['vtitle']!='' && $_POST['videogallery']!='')
 {
 
  
$query = "INSERT INTO videogallery (`vtitle`,`videogallery`,`cdate`) Values ('".$_POST['vtitle']."','".$_POST['videogallery']."','".$cdate."')";
...
<div class="textbar"> <input type="text" class="form-control" name="videogallery" placeholder="YouTube Video URL"></div>
