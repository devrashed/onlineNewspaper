...
$query = "INSERT INTO newstype (`title`,`category`,`sardes_category`,`description`,`images`,`slideshow`,`author`,`nstatus`,`bracking`,`youtube`,`topnews`,`ctime`,`cdate`,`btime`,`bdate`) Values ('".$_POST['sportstitle']."','".sports."','".$_POST['sports']."','".$content."','".$filePath."','".$_POST['slide']."','".$_POST['reporter']."'
,'". 1 ."','".$_POST['bknews'] ."','".$_POST['youtube']."','".$_POST['topnews']."','".$CUR_D_Bangladesh."','".$GM_D."','".$presenttime."','".$presentDate."')";
