...
<?php 
		...
		elseif  ($act == "newuser") require_once 'newuser.php';
		elseif  ($act == "menu") require_once 'menu.php';
		elseif  ($act == "permission") require_once 'permission.php';
		elseif  ($act == "leftmenu") require_once 'leftmenu.php';
		elseif  ($act == "dorbarsharif") require_once 'dorbarsharif.php';
		elseif  ($act == "khatmenabuya") require_once 'khatme-nabuyat.php';
		elseif  ($act == "pressclub") require_once 'press-club.php';
