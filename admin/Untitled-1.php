...
<head>
	...
	input.submit, input.submit-advanced, .featured-price, h3, h4, h5, h6, .listings-address-widget, .page-indetails, .pagination, .button, .property-information-address, .property-information-price, #child-pages li a {font-family: '<?php echo of_get_option('submenu_font', 'Open Sans'); ?>', sans-serif; font-weight:600;}
	...
	<div class="header-top">
		<div class="width-container">
			<div class="header-top-left">
				...
				<span href="" class="phone-header-top" style="float:left; margin-top:25px;"><?php echo of_get_option('phone_number', '(800) 536-3532'); ?></span>
				<?php endif; ?>
