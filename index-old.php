...
<div style="width:auto; height:40px; float:left;"><div class="news-bar">শিরোনাম</div></div>
...
<?php if ('$CGM_D'>=$vquery['end_date']) { ?>
    	...
    	echo "Here is your Advertisment";
		}
	}
?>2
</div>
...
<div class="leftad">
 ...
 ?>  
 <?php if ("$CGM_D">=$vquery['end_date']) {?>
<a href="<?php echo $vquery['weburl'];?>" target="_blank"><img src="admin/<?php echo $vquery['titleimages'];?>" class="imgleftad"></a>
<?php 
} else
...
<div class="rightadver"> 
 ...
 ?>  
 <?php if ('$CGM_D'>=$vquery['end_date']) {?>
<a href="<?php echo $vquery['weburl'];?>" target="_blank"><img src="admin/<?php echo $vquery['titleimages'];?>" class="imgrightad"></a>
<?php 
} else
...
<?php include "sports.php" ;?>  
 ...
 ?>  
 <?php if ('$CGM_D'>=$vquery['end_date']) {?>
<a href="<?php echo $vquery['weburl'];?>" target="_blank"><img src="admin/<?php echo $vquery['titleimages'];?>" class="colrightad"></a>
<?php 
} else
...
<!--<iframe src="http://www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fpages%2Fcurrentnewsbd24com%2F320278748161275%3Fref%3Dbookmarks&width&height=225&colorscheme=light&show_faces=true&header=true&stream=false&show_border=true" style="border:none; overflow:hidden; height:225px; width:382px;" allowTransparency="true"></iframe>-->
</div>
...
<?php
$query= "SELECT * FROM advertise where block='block-18' order by aid DESC LIMIT 1";
$rsquery= mysql_query($query); 
while ($vquery=mysql_fetch_array($rsquery))
{
?>  
