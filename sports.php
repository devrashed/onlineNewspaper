 <?php
 $query= "SELECT * FROM newstype WHERE category='sports' AND sardes_category='cricket' order by nid DESC LIMIT 1";
 $rsquery= mysql_query($query); 
 while ($vquery2=mysql_fetch_array($rsquery))
    {
 ?>
<div class="separte-col">
...
<?php } ?> 
 ...
 <?php
 $query= "SELECT * FROM newstype WHERE category='sports' AND sardes_category='football' order by nid DESC LIMIT 1";
 $rsquery= mysql_query($query); 
 while ($vquery2=mysql_fetch_array($rsquery))
    {
 ?>
...
<?php } ?> 
 ...
 <?php
 $query= "SELECT * FROM newstype WHERE category='sports' AND sardes_category='others' order by nid DESC LIMIT 1";
 $rsquery= mysql_query($query); 
 while ($vquery2=mysql_fetch_array($rsquery))
    {
 ?>
...
<?php
	...
	$query= "SELECT * FROM newstype WHERE category='sports'  order by nid DESC LIMIT 3, 10";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
?>
...
<div class="po-de"><a href="inn.php?catid=sports">আরো খবর</a></div>
