 <?php
 $query= "SELECT * FROM newstype WHERE category='dorbarsharif' order by nid DESC LIMIT 1";
...
<?php
	...
	$query= "SELECT * FROM newstype WHERE category='dorbarsharif' order by nid DESC LIMIT 1, 6";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
?>
