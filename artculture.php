<div class="artculture-news-title"> 
 <div class="artculture-news">
  <a href="#"> শিল্প ও সাহিত্য</a>
 </div> 
<div class="clr"> </div>
</div>
 <?php
 $query= "SELECT * FROM newstype WHERE category='artculture' order by nid DESC LIMIT 1";
...
<?php
	...
	$query= "SELECT * FROM newstype WHERE category='artculture' order by nid DESC LIMIT 1, 6";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
?>
...
<div class="po-de"><a href="inn.php?catid=dorbarsharif">আরো খবর</a></div>
