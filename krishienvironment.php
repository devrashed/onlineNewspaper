<div class="krishi-news-title"> 
    <div class="krishi-news">
 ...
 <?php
 $query= "SELECT * FROM newstype WHERE category='krishienvironment' order by nid DESC LIMIT 1";
...
<?php
	...
	$query= "SELECT * FROM newstype WHERE category='krishienvironment' order by nid DESC LIMIT 1, 6";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
?>
