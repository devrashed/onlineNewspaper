 <script type="text/javascript">
				...
				$(document).ready(function() {
				  // $.noConflict();
					...
					jQuery('#services-example-8').services(
						{
							width:1112,
							height:390,
                            slideAmount:5,
...
<div id="services-example-8" class="theme1">
                    <ul>
					
<?php
   $query= "SELECT * FROM newstype WHERE sardes_category='dhaka' order by nid DESC LIMIT 10";
