 <?php
 $query= "SELECT * FROM newstype WHERE category='khatme' order by nid DESC LIMIT 1";
...
<?php
	...
	$query= "SELECT * FROM newstype WHERE category='khatme' order by nid DESC LIMIT 1, 6";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
?>
...
<div class="po-de"><a href="inn.php?catid=khatme">আরো খবর</a></div>
