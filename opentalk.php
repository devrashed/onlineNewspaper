<div class="opentalk-news-title"> <div class="opentalk-news"><a href="inn.php?catid=opentalk">খোলা কলম</a></div> 
<div class="clr"></div>
</div> 
 <?php
 $query= "SELECT * FROM newstype WHERE category='opentalk' order by nid DESC LIMIT 1";
...
<?php
	...
	$query= "SELECT * FROM newstype WHERE category='opentalk' order by nid DESC LIMIT 1, 6";
	$rsquery= mysql_query($query); 
	while ($vquery2=mysql_fetch_array($rsquery))
    {
?>
...
<div class="po-de"><a href="inn.php?catid=opentalk">আরো খবর</a></div>
